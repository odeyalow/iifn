      ...
      <section className="w-full sm:min-h-[80svh] bg-yellow-1 rounded-[20px] p-15 max-sm:p-10 mt-12 flex flex-col justify-between gap-10 relative">
        <div className="max-sm:mb-40">
          <h1 style={{fontSize: 'clamp(2.5rem, 5vw, 5.5rem)'}}
            className="font-extrabold text-red-1 mb-15 max-sm:mb-10">{t('hero.title.1')}</h1>
          <div className="flex">
            ...
            <p style={{fontSize: 'clamp(1.5rem, 2vw, 1.8rem)'}}
              className="font-medium lg:leading-10">{
        ...
        <div className="flex gap-5 sm:hidden relative z-2">
        ...
        className="max-w-[500px] absolute max-sm:max-w-[175px] max-sm:-right-10 -right-25 -bottom-45 max-lg:-bottom-15 max-md:-bottom-7"/>
      </section>
    </>
  );
}
